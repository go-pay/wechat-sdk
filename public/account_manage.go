...
func (s *SDK) QRCodeCreate(c context.Context, body bmap.BodyMap) (qr *model.QRCodeRsp, err error) {
...
func (s *SDK) ShortKeyGen(c context.Context, body bmap.BodyMap) (skg *model.ShortKeyGenRsp, err error) {
